...
🔍 تحليل الصور المطلوب:
1. صورة المنتج: حدد نوع المنتج، الفئة (علبة/زجاجة/إكسسوار/etc)، الألوان، والبراند، اسم المنتج بدقة.
2. صورة المشهد: فهرس كل المنتجات والعناصر الموجودة واماكنها بدقة.

🎯 استراتيجية الاستبدال الذكي:

خطوة 1: استبدال المنتج القديم كاملاً (حاسمة)
- ابحث عن نفس فئة المنتج في المشهد يعني لو كان منتج علبة يبقي هو دا الي هيتم استبداله بالفعل
-حدد مكان المنتج وابعاده وشكله.
- استبدال المنتج القديم **بالكامل** - لا تبقي أي أثر له
- هذه عملية **استبدال** ليس إضافة - يجب أن يبقى منتج واحد فقط
- اعمل inpainting للخلفية في المكان الذي كان فيه المنتج القديم

خطوة 2: وضع المنتج الجديد بدقة
...
-شاهد المنتج الجديد وهل هو مناسب في هذه الوضعيه ام لا
...
- حافظ على 100% من العمارة
- حافظ على 100% من الأثاث
- حافظ على 100% من الديكور
- حافظ على كل مصادر الإضاءة الأصلي

🚨 قواعد الحفاظ التام على المشهد:
- ✅ استبدل منتج واحد فقط من نفس الفئة
...
- ✅ النتيجة: المشهد الأصلي بالضبط + منتج مستبدل واحد فقط في نفس الموقع بالضبط

طلب المستخدم المحدد: "${userDescription}"

⚡ اكتب الآن تعليمات دقيقة بالإنجليزية للذكاء الاصطناعي تشمل كل هذه التعليمات
