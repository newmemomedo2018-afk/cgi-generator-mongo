...
🔍 خطوة 0: تحليل تعقيد المشهد (CRITICAL):

حدد نوع المشهد:

TYPE A - مشهد بسيط (Simple Scene):
- منتج واحد في بيئة طبيعية (على طاولة، أرض، رف)
- إضاءة عادية
- بدون تأثيرات CGI معقدة
→ الاستبدال: مباشر وسهل

TYPE B - مشهد متوسط (Moderate Scene):
- منتج واحد مع تأثيرات بسيطة (انعكاسات، ظلال خفيفة)
- إضاءة احترافية
→ الاستبدال: ممكن مع مطابقة التأثيرات

TYPE C - مشهد معقد (Complex Scene):
- منتجات متعددة في حركة/تطاير
- تأثيرات CGI قوية (بودرة، سوائل، انفجارات)
- إضاءة درامية معقدة
→ الاستبدال: **تكيّف ذكي مطلوب**

🧠 استراتيجية التعامل مع المشاهد المعقدة (TYPE C):

إذا كان المشهد TYPE C، طبق القواعد التالية:

1️⃣ تبسيط المشهد:
   - اختر **أبرز موضع** في المشهد
   - احذف المنتجات الإضافية/المكررة
   - ضع المنتج الجديد في الموضع المركزي الأكثر بروزاً

2️⃣ تكييف التأثيرات:
   - إذا كان المشهد فيه حركة (flying, exploding):
     → ضع المنتج في وضع ثابت رئيسي
   - إذا كان المشهد فيه تأثيرات (powder, splash):
     → طبق التأثيرات حول المنتج الجديد بما يناسب طبيعته
   - إذا كان المشهد فيه إضاءة درامية:
     → حافظ على نفس الإضاءة

3️⃣ الحفاظ على جوهر المشهد:
   - اجعل المنتج الجديد هو **النجم** الوحيد
   - احتفظ بـ: الخلفية، الإضاءة، المزاج العام، التأثيرات البيئية
   - احذف: المنتجات القديمة كلها

مثال TYPE C:
- المشهد: 3 علب مشروب متطايرة + بودرة ملونة + إضاءة درامية
- الحل: ضع علبة الدهان في الموضع المركزي السفلي، أزل كل العلب الثلاث، احتفظ بالبودرة الملونة حول العلبة الجديدة، نفس الإضاءة الدرامية

🎨 تعليمات خاصة بالمشاهد الغريبة/المعقدة:

- **إذا كان المشهد سريالي**: اجعل المنتج الجديد ينسجم مع السريالية
- **إذا كان المشهد فيه منتجات كثيرة**: استبدل الأكثر بروزاً فقط واحذف الباقي
- **إذا كان المشهد مجرد تأثيرات بدون منتج واضح**: ضع المنتج الجديد في المركز كبطل للمشهد
- **إذا كان المشهد غير منطقي**: ركز على جعل المنتج الجديد هو المحور الرئيسي

📐 مطابقة الحجم:
${productSize === 'emphasized' ? 
'- اجعل المنتج أكبر بنسبة 25-30% من الطبيعي\n- ضعه في موضع بارز ومركزي' : 
'- استخدم حجم مناسب للمشهد\n- إذا كان المشهد معقد، ضع المنتج في حجم يجعله البطل الواضح'}

🎨 الخرج المطلوب (بالإنجليزية فقط):
اكتب تعليمات واضحة ومختصرة (أقل من 200 كلمة) تتضمن:
1. تصنيف المشهد (Type A/B/C)
2. وصف المنتج الجديد
3. استراتيجية الاستبدال المناسبة للمشهد
4. التأثيرات والإضاءة المطلوبة
5. ما يجب حذفه وما يجب الحفاظ عليه

تذكر: مهما كان المشهد معقداً أو غريباً، المنتج الجديد يجب أن يكون هو النجم الوحيد في المشهد النهائي.`
