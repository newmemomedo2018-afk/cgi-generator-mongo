...
export async function enhancePromptWithGemini(
  ...
  try {
    ...
    const result = await model.generateContent([
      ...
      `انت خبير CGI. حلل الصورتين:
1. المنتج الجديد: شوف الشكل والألوان والنوع والوظيفة
2. المشهد: شوف البيئة والإضاءة والمساحة المتاحة

المطلوب: "${userDescription}"

قواعد ذكية:
- لو حاوية (علبة، كوباية، زجاجة): غير الشكل الخارجي بس، خلي المحتوى الداخلي زي ما هو
- لو أثاث (كنبة، طاولة، خزانة): غير المنتج كله واحتفظ بالبيئة
- لو ديكور (لوحة، مرآة، ساعة): استبدل في نفس المكان المناسب
- لو منتج جديد مش مذكور: حلل وظيفته واختار المكان المنطقي ليه في المشهد

القواعد العامة:
- احتفظ بالإضاءة والخلفية الأصلية
- ضع المنتج في المكان اللي يناسب استخدامه
- اشيل أي منتج متعارض موجود في نفس المكان

الهدف العام ان يحل المنتج الجديد محل المنتج القديم بشكل طبيعي وواقعي (تحقق دمج CGI محترف
 مع الحفاظ على جو المشهد الأصلي
 - جودة عالية، تفاصيل واضحة، إضاءة واقعية
 - لا تضيف أي عناصر أو منتجات إضافية غير المطلوبة
- لا تغير ألوان أو تصميم المنتج الجديد
- لا تغير في المشهد الأصلي غير إزالة العناصر المتعارضة
- المنتج يكون بحجم طبيعي ومتناسق مع باقي عناصر المشهد
- لو المنتج مُبرز، زوده بنسبة 20-30% عن الحجم الطبيعي
- لا تضيف أو تقلل الحجم، خليه مناسب للمكان

- الإضاءة طبيعية ومتوازنة مع باقي المشهد
- المنتج يندمج بشكل طبيعي دون إبراز زائد
)

اكتب تعليمات إنجليزي مختصرة للـ AI. ولا يزيد البرومبيت عن ٢٠٠ كلمه`
