...
خطوة 1: إزالة المنتج القديم كاملاً (حاسمة)
- ابحث عن نفس فئة المنتج في المشهد (ثريا ← ثريا، إضاءة ← إضاءة)  
- أزل المنتج القديم **بالكامل** - لا تبقي أي أثر له
...
- ✅ استبدل منتج واحد فقط من نفس الفئة (ثريا ← ثريا، إضاءة ← إضاءة)  
- ❌ لا تضيف منتجات جديدة للمشهد - فقط استبدال
- ❌ لا تضع المنتج في مكان فارغ أو فوق الستائر أو خارج موقع المنتج الأصلي
...
⚠️ تحديد موقع الاستبدال الدقيق:
- في مشهد القصر: استبدل الثريا الكريستال الكبيرة المتعلقة في وسط السقف
- لا تضع المنتج فوق الستائر أو في منطقة فارغة
- المنتج الجديد يجب أن يتعلق من نفس نقطة التعليق في السقف
