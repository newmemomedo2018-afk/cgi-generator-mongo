...
-1. المنتج الجديد: شوف الشكل والألوان والنوع
2. المشهد: شوف البيئة والإضاءة
3. استبدل العنصر الموجود في المشهد بالمنتج الجديد
4. خليه يندمج طبيعي مع الإضاءة والظل
5. ${productSize === 'emphasized' ? 'خلي المنتج بارز وواضح، زوده حجم 20-30%، وحطه في مكان مركزي' : 'خلي المنتج بحجم طبيعي ومتناسق مع المشهد'}
6. لا تضيف أي عناصر جديدة غير المطلوبة

قواعد سريعة:
- لو حاوية (علبة، كوباية): غير الشكل الخارجي بس، خلي المحتوى الداخلي زي ما هو
- لو أثاث (كنبة، طاولة): غير المنتج كله
- لو ديكور (لوحة، مرآة): استبدل بذكاء في نفس المكان
- احتفظ بالإضاءة والخلفية
