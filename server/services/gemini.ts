...
1️⃣ حلل PRODUCT IMAGE:
   - ما نوع المنتج؟ (حاوية، أثاث، ديكور، طعام، آلة، نبات، حيوان، إلخ)
   - ما حجمه التقريبي؟
   - ما ألوانه ومواده؟
   - ما الكتابة أو البراند عليه؟

2️⃣ حلل SCENE IMAGE:
   - ما المنتج الموجود في المشهد حالياً؟
   - أين موقعه بالضبط؟
   - ما حجمه ومقياسه في المشهد؟
   - ما الإضاءة والظلال حوله؟

3️⃣ قرار الاستبدال الذكي:
   - إذا كان المنتج حاوية مفتوحة (علبة دهان، كوب، إناء) مع محتوى داخلي مرئي:
     → استبدل الحاوية الخارجية فقط
     → احتفظ بالمحتوى الداخلي (السائل، الأشياء جوا، الديكور الداخلي) 100%
   
   - إذا كان المنتج حاوية مغلقة أو أي منتج آخر:
     → استبدل المنتج بالكامل
     → ضعه في نفس الموقع والحجم والزاوية
   
   - إذا لم يكن هناك منتج واضح في المشهد:
     → اختر المكان الأنسب والأكثر منطقية للمنتج الجديد

🚨 قواعد الاستبدال الحاسمة:

✅ يجب:
- إزالة المنتج القديم نهائياً (لا أثر، لا ظل، لا بقايا)
- وضع المنتج الجديد في نفس الموقع بالضبط
- مطابقة الحجم والمقياس (إلا إذا طلب المستخدم "emphasized")
- مطابقة الإضاءة والظلال تماماً
- الحفاظ على كل عناصر الخلفية (جدران، أرض، سماء، أشخاص، أثاث بعيد)
- الحفاظ على المنظور والزاوية
- النتيجة النهائية: منتج واحد فقط (المنتج الجديد) في المشهد

❌ ممنوع:
- وضع المنتج في مكان غريب أو غير منطقي
- ترك المنتج القديم أو أجزاء منه
- تغيير حجم المنتج بشكل غير طبيعي
- إضافة منتجات إضافية غير مطلوبة
- تغيير الخلفية أو البيئة

📐 مطابقة الحجم:
${productSize === 'emphasized' ? 
'- اجعل المنتج أكبر بنسبة 25-30% من الطبيعي\n- ضعه في موضع بارز ومركزي' : 
'- استخدم نفس حجم المنتج القديم تماماً\n- نفس الموضع، نفس الزاوية، نفس المقياس'}

🎨 الخرج المطلوب (بالإنجليزية فقط):
اكتب تعليمات واضحة ومختصرة (أقل من 150 كلمة) تتضمن:
1. وصف المنتج الجديد (من PRODUCT IMAGE)
2. موقع وحجم الاستبدال المحدد
3. تعليمات إزالة المنتج القديم
4. متطلبات الإضاءة والظلال
5. عناصر الخلفية التي يجب الحفاظ عليها

تذكر: الهدف هو استبدال منتج بمنتج في نفس المكان بالضبط، مع الحفاظ على كل شيء آخر.`
